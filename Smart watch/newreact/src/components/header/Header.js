        ...
        <div className="container_div">
          <div className=" max-[447px]:flex-wrap max-[768px]:flex-wrap flex gap-32 py-28 px-24 max-[768px]:px-2 max-[447px]:px-2 ">
            ...
            <div className="header-img relative   ">
              <img
                className=" mx-14 w-[300px]"
                src="./assets/imgright.png"
                alt=""
              />
              <img
                className="absolute  bottom-12 right-[-80px] z-40"
                src="./assets/marko.png"
                alt=""
              />
              <span className="w-[50px] h-[50px] bg-[#FFDDD2] block rounded-full absolute bottom-72 right-[450px]">
                {" "}
              </span>
              <span className="w-[30px] h-[30px] bg-[#FFDDD2] block rounded-full absolute bottom-32 right-[300px]">
                {" "}
              </span>
              <span className="block absolute top-[-20px] right-[-50px] w-[30px] h-[30px] bg-[#BEE1E6D9] rounded-full"></span>
            </div>
          </div>
        </div>
        ...
        <div className="header-cards flex justify-around px-24 py-12 gap-3 max-[447px]:flex-wrap max-[768px]:flex-wrap">
          <div className="h-card1 flex gap-5 border-[2px] h-28 px-4 py-3 ">
            ...
            <div className="">
              ...
              <span className="text-[#101828] font-[400] py-2">$36.80</span>
            </div>
          </div>
          <div className="h-card1 flex gap-5 border-[2px] h-28 px-4 py-3 ">
            ...
            <div className="">
              ...
              <span className="text-[#101828] font-[400] py-2">$35.80</span>
            </div>
          </div>
          <div className="h-card1 flex gap-5 border-[2px] h-28 px-4 py-3 ">
            ...
            <div className="">
              ...
              <span className="text-[#101828] font-[400] py-2">$29.80</span>
            </div>
          </div>
        </div>
      </header>
...
<div className="main-cards flex flex-wrap px-14 py-16 gap-5 justify-between" >
<div className="main-card w-[300px] h-[400px] gap-5 border-[2px] px-4 py-4  hover:scale-110 duration-200 transition-transform">    
...
<div className="main-card w-[300px] h-[400px]  border-[2px] px-4 py-4  hover:scale-110 duration-200 transition-transform">
...
<div className="main-card w-[300px] h-[400px]  border-[2px] px-4 py-4  hover:scale-110 duration-200 transition-transform">
{/* <img className="pb-5 mx-auto" src="./images/a 1.png" alt=""> */}
...
<div className="title font-bold m-auto py-14">
   <h1 className="text-[42px] font-medium text-center">Explore by Categories.</h1>
   <h5 className="text-[16px] font-normal py-4 w-[500px] m-auto text-center">We provide many categories, choose a category according to
       your expertise to make it easier to find a job.</h5>
 </div>
 <div className="grid grid-cols-2  place-items-center gap-14 mx-6">
   ...
   <div  className="grid grid-cols-2 gap-5 ">
     <div className= "border-2 flex gap-5 items-center py-7 px-4 rounded-md">
       ...
       <p  className=" text-sm font-semibold">Computer for Designer, Art</p>
     </div>
     ...
     <div className= "border-2 flex gap-5 items-center py-7 px-4 rounded-md">
       ...
       <p  className= "text-sm font-semibold">Laptop for office, students</p>
     </div>
     <div className= "border-2 flex gap-5 items-center py-7 px-4 rounded-md">
       <p  className= "w-10 h-10 flex  items-center justify-center bg-cyan-400 rounded-full ">
 ...
 <div className="title">
   <button className="px-5 py-3 mt-8 bg-[#f6e9df] text-[#E29578] rounded-lg mx-auto flex" >How It Work ?</button>

 </div>
 <div> <h1 className="font-medium text-5xl w-[600px] py-8 text-center mx-auto">Cross-border ordering has
...
<div className="fl-cards py-10 flex flex-wrap gap-20 justify-center px-16">
   <div className="card text-center w-[250px] h-[300px] bg-[#FFF3EA] py-10 hover:translate-y-[-20px] transition-all ease-in-out">
       ...
       <p className="text-[#667085] px-7">Choose any of
           our packages</p>
...
<div className="main-end relative  w-full h-[400px] bg-[#006D77] text-white py-28 px-16 rounded-2xl ">
   ...
   <p className="font-normal w-[400px]  ">By clicking the button, you are agreeing with our Term & Conditions</p>
  
   <input  className="px-10  py-3 mt-4 rounded-3xl"  type="email" placeholder="Enter you mail..."  />
   <i className=" fa-solid fa-arrow-right absolute left-64 bg-[#006D77] text-white bottom-36 px-3 py-3 rounded-full"></i>
</div>
<div className="relative">
 <img  className="absolute right-5 bottom-[-80px]  transition-all ease-in-out  " src="./assets/absolimg.png" alt="" />
</div>
<div className="relative">
 <img  className="absolute bottom-10 right-80 w-[350px] h-[250px] " src="./assets/marko.png" alt="" />
</div>

<footer>
<div className="footer pt-40 pb-10 px-20">
 <div className="footer-start flex justify-between mb-10" >
   {/* <div className="logo"><img src="./images/logo.png" alt=""></div> */}
   <img src="./assets/logo.png" alt="" />
  <div className="btn"> Ready to get started?  <button className="rounded-3xl mx-5 px-7 py-2 bg-[#101828] text-white transition-all .5s ease-linear hover:bg-[#233a68] " >Create an Account →</button> 
  </div>
 </div>
...
<div className="footer-links flex justify-between  gap-10 px-20  py-5">
...
<div className="w-[1220px] ml-20 h-[2px] bg-[#D6D8DD] px-20"  ></div>

<div className="footer-end flex justify-between px-20 py-10 text-[#969696]">
   <p>©Agon Official 2022
   </p>
   <p>Privacy policy
       Cookies
       Terms of service</p>
