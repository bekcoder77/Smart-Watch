    ...
    <div>
      <header>
        ...
        <div className="container_div ">
          <div className=" max-[447px]:flex-wrap max-[768px]:flex-wrap flex  py-24 pl-24 max-[768px]:px-2 max-[447px]:px-2  ">
            ...
            <img
                className=" mx-14 lg:w-[320px] lg:h-[370px] md:w-[250px] md:h-[280px] sm:w-[300px] sm:h-[350px] "
                src="./assets/imgright.png"
                alt=""
              />
            </div>
              <img
                className="absolute max-[447px]:hidden  bottom-[-50px] right-[-50px] z-40 max-[510px]:right-0 "
                src="./assets/marko.png"
                alt=""
              />
              <span className="w-[50px] h-[50px] bg-[#FFDDD2] block rounded-full absolute bottom-72 right-[450px] lg:flex sm:hidden md:hidden max-[510px]:hidden">
                {" "}
              </span>
              <span className="w-[40px] h-[40px] bg-[#FFDDD2] block rounded-full absolute bottom-20 right-[350px] lg:flex sm:hidden md:hidden max-[510px]:hidden">
                {" "}
              </span>
              <span className="block absolute top-[-20px] right-[-50px] w-[30px] h-[30px] bg-[#BEE1E6D9] rounded-full lg:flex sm:hidden md:hidden max-[510px]:hidden"></span>
            </div>
          </div>
        </div>
        ...
        <div className="header-cards flex justify-around px-24 py-12 gap-3 max-[510px]:gap-20 max-[447px]:flex-wrap max-[768px]:flex-wrap">
          <div className="h-card1  flex max-[510px]:flex-col  items-center border-[2px] gap-5 px-4 py-3 ">
            <img className='object-contain w-[200px] ' src="./assets/tele.png" alt="" />
            <div className="fl-el  ">
          ...
          <div className="h-card1  flex max-[510px]:flex-col items-center  border-[2px] gap-5 px-4 py-3 ">
            <img className='object-contain w-[150px] ' src="./assets/nn1.png" alt="" />
            <div className="fl-el  ">
              <p className="font-normal pb-4">
                4K TV Game Mini Arcade Rocker Console 32GB/64GB
              <p className="text-[#006D77] font-[700] py-2">$36.80</p>
          ...
          <div className="h-card1  flex max-[510px]:flex-col  items-center border-[2px] gap-5 px-4 py-3 ">
            <img className='object-contain w-[150px] ' src="./assets/nn2.png" alt="" />
            <div className="fl-el  ">
              <p className="font-normal pb-4">
                4K TV Game Mini Arcade Rocker Console 32GB/64GB
              <p className="text-[#006D77] font-[700] py-2">$36.80</p>
